      ...
      <div className="container-custom relative">
        ...
        <div className="mt-16 max-w-4xl mx-auto p-8 rounded-2xl bg-white/70 backdrop-blur-sm border border-primary/10 shadow-soft opacity-0 animate-scale-in animate-delay-400">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">Desenvolvido para estudantes do IFB</h3>
              <p className="text-muted-foreground">
                Nosso chatbot <span className="font-medium text-primary">Zap Crítico</span> foi criado especificamente para atender às necessidades dos estudantes da 
                Educação Profissional e Tecnológica do Instituto Federal de Brasília (IFB), oferecendo recursos que promovem o desenvolvimento 

      ...
      <div className="container-custom flex items-center justify-between">
        ...
        >
          <div className="flex items-center space-x-2">
            <img
              src="../images/Zap Crítico.svg"
              alt="Logo zap critico"
              className="w-30 h-20"
            />
          </div>
        </a>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a
            ...
            className="text-sm font-medium bg-primary text-white px-4 py-2 rounded-md hover:bg-primary/90 transition-colors flex items-center space-x-2"
          >
            <svg
              width="18"
              height="18"
            ...
            <div className="flex flex-col h-full">
              ...
              <nav className="flex flex-col p-6 space-y-6">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-base font-medium bg-primary text-white px-4 py-3 rounded-md hover:bg-primary/90 transition-colors flex items-center justify-center space-x-2 mt-4"
                >
                  <svg
                    width="20"
                    height="20"
